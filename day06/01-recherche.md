...
push ajoute un ou plusieur element a la fin du tableau et unshift ajoute un ou plusieur au debut de tableau
...
pop supp le derniere element et shift supp le premier
...
for...in parcourt les cles ou index et for...of parcourt les valeurs
...
La méthode standard et recommandée est Array.isArray()
...
il ya le methode .concat() et en peut fusionner avec .push() et en peut creer un autre tab et en ajoute les deux
...
slice extrait une partie du tableau et renvoie un nouveaux sans modifier le tableaux d'origine et splice modifie le tableaux d'origine en supp , ajout et remplacent les elements
...
oui en peut mes ce n'est pas une bonne pratique
